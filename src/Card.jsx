...
const Card = (props) => {
  return (
    <>
        ...
        <div className="relative w-1/2 group max-w-md min-w-0 mx-auto mt-20 mb-6 break-words bg-white border shadow-2xl dark:bg-gray-800 dark:border-gray-700 md:max-w-sm rounded-xl">
          <div className="pb-6">
                ...
                <div className="flex justify-center pt-8 pb-0 lg:pt-4">
                  <div className="flex space-x-2">
                    <a
                      ...
                      rel="noopener"
                       xmlns="https://twitter.com/we_st6"
                    ...
                    <a
                      className="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary"
                      rel="noopener"
                       src="https://github.com/westhly"
                    //   ariaLabel="Ariel Cerda on Github"
                      target="_blank"
                    >
                      <svg
                        className="w-6 h-6 overflow-visible fill-current"
                    ...
                    <a
                      className="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary"
                       xmlns="https://www.linkedin.com/in/westhly-sarabia-b1364823b/"
                      rel="noopener"
                      // ariaLabel="Ariel Cerda on Linkedin"
                      target="_blank"
                    >
                      <svg
                        className="w-6 h-6 overflow-visible fill-current"
                    ...
                    <a
                      className="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary"
                      rel="noopener"
                       xmlns="https://www.instagram.com/westhlyjose/"
                      // ariaLabel="Ariel Cerda on Instagram"
                      target="_blank"
                    >
                      <svg
                        className="w-6 h-6 overflow-visible fill-current"
            ...
            <div className="relative h-6 overflow-hidden translate-y-6 rounded-b-xl">
              <div className="absolute flex -space-x-12 rounded-b-2xl">
                <div className={`w-36 h-8 transition-colors duration-200 delay-75 transform skew-x-[35deg] ${props.color1}`}></div>
                <div className={`w-28 h-8 transition-colors duration-200 delay-100 transform skew-x-[35deg] ${props.color2}`}></div>
                <div className={`w-28 h-8 transition-colors duration-200 delay-150 transform skew-x-[35deg] ${props.color3}`}></div>
                <div className={`w-28 h-8 transition-colors duration-200 delay-200 transform skew-x-[35deg] ${props.color4}`}></div>
                <div className={`w-28 h-8 transition-colors duration-200 delay-300 transform skew-x-[35deg] ${props.color5}`}></div>
              </div>
            </div>
          </div>
